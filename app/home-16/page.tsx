...
export const metadata = {
  title: 'Innovative Marketing  - Credit Master AI',
}
  ...
  return (
    <LayoutTwo>
      ...
      <AboutV15
        ...
        subTitle="At Credit Master AI Marketing Agency, we believe in creating impactful, data-driven marketing campaigns that connect brands with their audiences. Our team of strategists, creatives, and data analysts work together to deliver measurable results that fuel business growth."

...
const servicesData = [
  {
    ...
    subtitle: 'Establish and grow your business credit profile with bureaus like D&B, Experian, and Equifax.',
    items: [
      'Business credit reports setup',
      'Vendor credit acquisition',
      'Retail and fleet credit lines',
      'Monitoring & smart growth tools',
    ],
  },
  {
    id: 2,
    title: 'Funding Access System',
    subtitle: 'Unlock funding sources from revolving credit to lending networks based on tier qualification.',
    items: [
      'Lender credibility optimization',
      'Tier-based lending connections',
      'Revolving and cash credit access',
      'AI-powered approval matching',
    ],
  },
  {
    id: 3,
    title: 'AI Dispute Manager',
    subtitle: 'Manage and improve your credit profile with dispute tools and bureau analysis.',
    items: [
      'myCreditMasterDispute Manager access',
      'Experian Smart Business Monitoring',
      'Bureau Insights™ audit report',
      'Error correction workflows',
    ],
  },
  {
    id: 4,
    title: 'Coaching & Advisement',
    subtitle: 'Work directly with experts for strategy, compliance, and growth-focused guidance.',
    items: [
      'One-on-one credit coaching',
      'Business credibility checklists',
      'Funding strategy sessions',
      'Debt planning and budgeting software',
    ],
  },
]
          ...
          <div className="flex-1 max-md:w-full md:self-end">
            <TextAppearAnimation>
              <p className="text-appear max-w-lg md:justify-self-end md:text-right">
                We help entrepreneurs establish true business credibility, build a solid credit profile with all major
                bureaus, and gain access to funding sources across vendor, retail, fleet, and revolving credit tiers.
              </p>
            </TextAppearAnimation>

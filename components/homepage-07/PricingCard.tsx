...
const designPricingList = [
  { list: 'Business Credit Finance Suite', feature: true },
  { list: 'Business Credit Education & Restoration', feature: true },
  { list: 'Personal Business Coaching & Advisement (6 mos)', feature: true },
  { list: 'Access to Lending Sources in Specific Tiers', feature: true },
  { list: 'myCreditMasterDispute Manager (6 mos)', feature: true },
  { list: 'Experian Smart Business Monitoring data', feature: true },
  { list: 'Personal Debt & Budgeting Software', feature: true },
  { list: 'TRUE VALUE OF SYSTEM - $11000', feature: true },
]

const customPricingList = [
  { list: 'Business Credit Finance Suite', feature: true },
  { list: 'Business Credit Education & Restoration', feature: true },
  { list: 'Personal Business Coaching & Advisement (6 mos)', feature: false },
  { list: 'Access to Lending Sources in Specific Tiers', feature: false },
  { list: 'myCreditMasterDispute Manager (6 mos)', feature: false },
  { list: 'Experian Smart Business Monitoring data', feature: false },
  { list: 'Personal Debt & Budgeting Software', feature: false },
  { list: 'TRUE VALUE OF SYSTEM - $11000', feature: false },
]
        ...
        <div>
          ...
          <div className="mt-10 grid justify-center gap-x-10 gap-y-10 md:mt-20 lg:grid-cols-2">
            <RevealWrapperV2 className="border border-secondary px-[30px] pb-[30px] pt-8 dark:border-backgroundBody md:pt-20">
              ...
              <div>
                <div>
                  <h6 className="mb-4 max-md:text-3xl">Business Credit and Funding Program</h6>
                  <p className="text-base">
                    Ideal for busy entrepreneurs seeking a cohesive approach for business credit building with full
                    support from our team
                  </p>
                </div>

                <div className="flex flex-col items-start gap-x-10 gap-y-3 py-8 md:flex-row md:items-end md:gap-y-6">
                  <p className="text-6xl leading-[60px] text-secondary dark:text-backgroundBody">$2495</p>
            ...
            <RevealWrapper className="border px-[30px] pb-[30px] pt-8 dark:border-dark md:pt-20">
              ...
              <div>
                <div>
                  <h6 className="mb-4 max-md:text-3xl">D.I.Y Solution</h6>
                  <p className="text-base">
                    A no-brainer solution for growing companies looking for managing their credits on their own
                  </p>
                </div>
                {pricingToggle ? (
                  <div>
                    <div className="flex flex-col items-start gap-x-10 gap-y-3 py-8 md:flex-row md:items-end md:gap-y-6">
                      <p className="text-6xl leading-[60px] text-secondary dark:text-backgroundBody">$995 </p>
                      <p className="text-sm leading-[18px] tracking-[-0.2px]">
                        One Time <br />
                        Only
                      </p>

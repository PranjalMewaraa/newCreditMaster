...
const data = [
  {
    id: 1,
    reviewText: 'Credit Master AI Films transformed our brand’s message into an unforgettable visual',
  ...
  {
    id: 2,
    reviewText: 'The team at Credit Master AI Films exceeded our expectations and delivered stunning results.',
    authorName: 'John Doe',
  ...
  {
    id: 3,
    reviewText: 'Working with Credit Master AI Films was a game changer for our project.',
  ...
  {
    id: 4,
    reviewText: 'The creativity and professionalism of Credit Master AI Films is unmatched.',

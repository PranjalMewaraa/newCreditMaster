      ...
      <div className="container">
        <div className="mb-8 text-center md:mb-14">
          <TextAppearAnimation>
            <h2 className="text-appear mt-3">
              Why choose <i className="font-instrument">Credit Master AI?</i>
            </h2>
          </TextAppearAnimation>
          <TextAppearAnimation>
            <p className="text-appear">The Credit Master AI Advantage — All That Works for You</p>
          </TextAppearAnimation>
        </div>
        <div className="flex flex-col-reverse gap-x-[30px] gap-y-8 md:flex-row">
          ...
          <RevealWrapper as="figure" className="md:w-1/2">
            <img src="/images/home-5/why-Credit Master AI.png" alt="AI Solutions" className="h-full w-full" />
          </RevealWrapper>
        </div>

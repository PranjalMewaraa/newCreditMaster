      ...
      <div className="mb-8 text-center md:mb-16">
        ...
        <TextAppearAnimation02>
          <h2 className="text-appear mb-3">
            AI powered Solution which <br />
            <i className="font-instrument"> gaurentees $50K Funding</i>
          </h2>
        </TextAppearAnimation02>
        <TextAppearAnimation>
          <p className="text-appear mx-auto lg:max-w-[770px]">
            Our AI-powered software seamlessly guides your business toward financial freedom, helping you secure funding
            and build strong business credit effortlessly
          </p>
        </TextAppearAnimation>
      </div>

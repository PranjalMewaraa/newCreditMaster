  ...
  return (
    <section className="pb-14 pt-14 md:pb-16 md:pt-16 lg:pb-[88px] lg:pt-[88px] xl:pb-[100px] xl:pt-[100px]">
      <div className="container">
        <div className="mx-auto mb-10 max-w-3xl text-start md:mb-16">
          <TextAppearAnimation>
            <h2 className="text-appear lg:leading-[1.1]">
              Why choose
              <span className="font-instrument italic"> Credit Master AI? </span>
            </h2>
          </TextAppearAnimation>
          <TextAppearAnimation>
            <p className="text-appear mt-3 text-lg font-normal text-black/70 dark:text-backgroundBody/70">
              At Credit Master, we don’t just plan things; we create experiences and implements sytem to boost your
              funding. Here’s why our clients trust us
            </p>
          </TextAppearAnimation>
        </div>
        ...
        <RevealWrapper className="reveal-me grid grid-cols-12 gap-[30px]">
          <div className="col-span-12 flex-1 border px-[30px] py-10 dark:border-dark lg:col-span-6">
            ...
            <h5 className="mb-3 mt-6">AI Powered Bureau Insights </h5>
            <p className="text-base font-normal leading-[25.6px] text-black/70 dark:text-backgroundBody/70">
              Years of experience in business credit programs
            </p>
            <div className="m-4 flex p-4">
              <div className="w-1/2">
                <h5 className="mb-3 mt-6">Secure and Confidential </h5>
                <p className="text-base font-normal leading-[25.6px] text-black/70 dark:text-backgroundBody/70">
                  Develop vitin lender suited to your profile
                </p>
              </div>
          ...
          <div className="col-span-6 grid grid-cols-1">
            ...
            <div className="col-span-12 flex-1 border px-[30px] py-10 dark:border-dark lg:col-span-6">
              ...
              <h5 className="mb-3 mt-6">Personalized Credit Strategy</h5>
              <p className="text-base font-normal leading-[25.6px] text-black/70 dark:text-backgroundBody/70">
            ...
            <div className="col-span-12 flex-1 border px-[30px] py-10 dark:border-dark lg:col-span-6">
              ...
              <h5 className="mb-3 mt-6">Dedicated Support Team</h5>
              <p className="text-base font-normal leading-[25.6px] text-black/70 dark:text-backgroundBody/70">

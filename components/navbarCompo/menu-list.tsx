...
const menuItems: MenuItemProps[] = [
  ...
  },
  {
    title: 'About',
    url: '/about-02',
    items: [{ title: 'About Credit Master Ai', url: '/about-02' }],
  },
  {
    title: 'Solutions',
    url: '#',
    items: [
      ...
      { title: 'US Business Formation', url: '/us-business-formation' },
      { title: 'Legal Requirement for Non US Resident', url: '/legal-requirement-non-us' },
      { title: 'Business Structure Options', url: '/business-structure-options' },
      { title: 'Access US Business Funding', url: '/accessing-us-business-funding' },
      { title: 'How Credit Reporting Works', url: '/how-credit-reporting-work' },
      { title: 'International Trading Opportunities', url: '/international-trading-opportunities' },
      { title: 'Inventories of Companies', url: '/inventories-of-companies' },
      { title: 'Advantage of Aged Companies', url: '/advantage-aged-companies' },
      { title: 'High Credit Report Packages', url: '/high-credit-reporting-packages' },
      { title: 'Broker Agreement', url: '/broker-agreement' },
      { title: 'Business Credit Advisory Agreement', url: '/business-credit-advisory' },
      { title: 'Credit Broker Affiliate Program', url: '/credit-broker-affiliate-program' },
      { title: 'Example Summary of Leads', url: '/example-summary-leads' },
    ],
  },
  {
    title: 'Why Choose Us',
    url: '/why-choose-us',
    items: [{ title: 'Why Choose Us', url: '/why-choose-us' }],
  },
  {
    title: 'Pricing',
    url: '/pricing',
    items: [{ title: 'Our Pricing Plan', url: '/pricing' }],
  },
  {
    title: 'Blog',
    url: '#',
    items: [{ title: 'Our Blogs', url: 'https://creditmaster.ai/blogs' }],
  },
  // {
  //   title: 'Projects',
  //   url: '#',

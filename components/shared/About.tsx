        ...
        <div className="container">
          <RevealWrapper>
            <h3 className="pb-10 sm:pb-20" ref={revealRef}>
              ...
              providing a personalized roadmap to build robust business credit, apply for financing, and secure
              approvals for substantial credit lines and loans—all within a single platform.​
            </h3>
          </RevealWrapper>
          <RevealWrapper>
            <CircleTextAnimation />

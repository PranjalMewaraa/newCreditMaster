  ...
  return (
    <footer className="w-full overflow-hidden">
      <div className="bg-backgroundBody dark:bg-secondary">
        <h5 className="footer-text-v2 w-full text-nowrap text-center font-satoshi text-[120px] font-medium uppercase leading-[100%] sm:text-[200px] md:text-[258px] lg:text-[300px] xl:text-[300px] 2xl:text-[350px]">
          CreditMaster
        </h5>
      </div>
      <div className="-mt-10 bg-backgroundBody py-4 dark:bg-dark sm:-mt-[70px] md:-mt-24 xl:-mt-28">
        <div className="container">
          ...
          <div className="relative z-10 flex flex-col flex-wrap justify-center gap-y-10 pt-10 sm:flex-row sm:justify-between sm:gap-y-16 md:pt-20">
            ...
            <div className="pr-8 max-lg:basis-full">
              <p className="mb-5 max-w-[360px]">
                At CreditMaster AI, We build your business profile to secure a minimum of 50k in funding.
              </p>
              <h5 className="mb-3 font-satoshi text-2xl font-medium leading-[1.1]">Address</h5>
              <p>3870 Ponte Ave #110 Addison, TX 75001.</p>
          ...
          <p className="mt-10 border-t pt-5 text-center dark:border-dark">All rights Reserved Credit Master AI</p>
        </div>
      </div>
    </footer>
  )
